...
public class LobbyFactura extends javax.swing.JFrame {

   
    public LobbyFactura() {
        initComponents();
        
        Factura xd = new Factura();
        xd.setSize(820, 610);
        xd.setLocation(0,0);
    ...
    private void initComponents() {
        ...
        BtnFuncionXLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, BtnFuncionXLayout.createSequentialGroup()
                .addGap(13, 13, 13)
                .addGroup(BtnFuncionXLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LobbyFactura().setVisible(true);
            }
        });
    }
